          ...
          <Carousel className="mb-4">
            <Carousel.Item>
              <img
                ...
                src="https://rukminim2.flixcart.com/fk-p-flap/1620/270/image/34515a3294c8a8f9.jpg?q=20"
                alt="Second Offer"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                className="d-block w-100"
                src="https://rukminim2.flixcart.com/fk-p-flap/1620/270/image/3d7827c92a670177.jpg?q=20"
                alt="Third Offer"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                className="d-block w-100"
                src="https://rukminim2.flixcart.com/fk-p-flap/1620/270/image/57d9b129e302642e.jpg?q=20"
                alt="Offer"
              />
            </Carousel.Item>
            <Carousel.Item>
              <img
                className="d-block w-100"
                src="https://rukminim2.flixcart.com/fk-p-flap/1620/270/image/86dd5564754e79f3.jpg?q=20"
                alt="Offer"
              />
            </Carousel.Item>
          </Carousel>
